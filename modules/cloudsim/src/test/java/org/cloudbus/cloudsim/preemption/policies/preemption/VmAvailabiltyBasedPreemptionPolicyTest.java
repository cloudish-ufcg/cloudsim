...
public class VmAvailabiltyBasedPreemptionPolicyTest {
	...
	private int PRIORITY_PROD = 0;
	private int PRIORITY_BATCH = 1;
	private int PRIORITY_FREE = 2;

	private PreemptableVm vm0;
	private PreemptableVm vm1;
	private PreemptableVm vm2;
	...
	public void testInitialization() {
		...
		Assert.assertEquals(1, policy.getPriorityToSLOTarget().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0.9, policy.getPriorityToSLOTarget().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0.5, policy.getPriorityToSLOTarget().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
	...
	public void testInvalidInitialization() {
		...
		propeties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_PROD), "1");
		propeties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		propeties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testInvalidInitialization5() {
		...
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testInvalidInitialization6() {
		...
		Properties properties = new Properties();
		properties.setProperty(PreemptionPolicy.NUMBER_OF_PRIORITIES_PROP, "3");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_PROD), "one");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testInvalidInitialization7() {
		...
		Properties properties = new Properties();
		properties.setProperty(PreemptionPolicy.NUMBER_OF_PRIORITIES_PROP, "3");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_PROD), "-1");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testInvalidInitialization8() {
		// setting properties
		double PRIORITY_DOUBLE = 0d;
		Properties properties = new Properties();
		properties.setProperty(PreemptionPolicy.NUMBER_OF_PRIORITIES_PROP, "3");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Double.toString(PRIORITY_DOUBLE), "1");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testInvalidInitialization9() {
		// setting properties
		int PRIORITY_NEGATIVE = -1;
		Properties properties = new Properties();
		properties.setProperty(PreemptionPolicy.NUMBER_OF_PRIORITIES_PROP, "3");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_NEGATIVE), "one");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_BATCH), "0.9");
		properties.setProperty(VmAvailabilityBasedPreemptionPolicy.SLO_TARGET_PREFIX_PROP + Integer.toString(PRIORITY_FREE), "0.5");
	...
	public void testCalcMipsOfSamePriorityToBeAvailable() {
		...
		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_PROD).isEmpty());

		Assert.assertEquals(vm0.getMips(), policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_BATCH).first());

		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_FREE).isEmpty());
		...
		Assert.assertEquals(vm1.getMips(), policy.calcMipsOfSamePriorityToBeAvailable(vm1), ACCEPTABLE_DIFFERENCE);

		// assert first vm would be preempted by second and available for new VM is 10 (5 available + 5 mips for vm0)
		Assert.assertEquals(vm0.getMips() * 2, policy.getAvailableMipsByVm(vm1), ACCEPTABLE_DIFFERENCE);
	}
	...
	public void testCalcMipsOfSamePriorityToBeAvailable2() {
		...
		Assert.assertEquals(10, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_BATCH).first());
		Assert.assertEquals(vm1, policy.getPriorityToVms().get(PRIORITY_BATCH).last());
		...
		Assert.assertEquals(2 * vm0.getMips(), policy.calcMipsOfSamePriorityToBeAvailable(vm2), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2 * vm0.getMips(), policy.getAvailableMipsByVm(vm2), ACCEPTABLE_DIFFERENCE);
	}
	...
	public void testCalcMipsOfSamePriorityToBeAvailableWithPriority0() {
		...
		vm0 = new PreemptableVm(1, 1, cpuReq, memReq, 0, PRIORITY_PROD, runtime);
		vm1 = new PreemptableVm(2, 1, cpuReq, memReq, 0, PRIORITY_PROD, runtime);
		...
		// checking after allocating VMs with priority 0
		Assert.assertEquals(10, policy.getPriorityToInUseMips().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2, policy.getPriorityToVms().get(PRIORITY_PROD).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_PROD).first());
		Assert.assertEquals(vm1, policy.getPriorityToVms().get(PRIORITY_PROD).last());

		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_BATCH).isEmpty());
		...
		vm2 = new PreemptableVm(2, 1, cpuReq, memReq, 5, PRIORITY_PROD, runtime);
	...
	public void testCalcMipsOfSamePriorityToBeAvailable3() {
		...
		vm0 = new PreemptableVm(0, 1, cpuReq, memReq, 0, PRIORITY_BATCH, runtime);
		...
		Assert.assertEquals(5, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_BATCH).first());
		...
		vm1 = new PreemptableVm(1, 1, cpuReq, memReq, 2, PRIORITY_BATCH, runtime);
		...
		vm2 = new PreemptableVm(2, 1, cpuReq, memReq, 5, PRIORITY_BATCH, runtime);
	...
	public void testCalcMipsOfSamePriorityToBeAvailable4() {
		...
		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_BATCH).first());
		...
		Assert.assertEquals(9.1, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_BATCH).first());
		Assert.assertEquals(vm1, policy.getPriorityToVms().get(PRIORITY_BATCH).last());
	...
	public void testCalcMipsOfSamePriorityToBeAvailable5() {
		...
		vm0 = new PreemptableVm(0, 1, cpuReq, memReq, 0, PRIORITY_PROD, runtime);
		vm1 = new PreemptableVm(1, 1, cpuReq, memReq, 0, PRIORITY_BATCH, runtime);
		vm2 = new PreemptableVm(2, 1, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		...
		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_PROD).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_PROD).first());

		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vm1, policy.getPriorityToVms().get(PRIORITY_BATCH).first());

		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_FREE).size());
		Assert.assertEquals(vm2, policy.getPriorityToVms().get(PRIORITY_FREE).first());
		...
		PreemptableVm vmP0 = new PreemptableVm(4, 1, cpuReq, memReq, 5, PRIORITY_PROD, runtime);
		...
		PreemptableVm vmP1 = new PreemptableVm(5, 1, cpuReq, memReq, 5, PRIORITY_BATCH, runtime);
		...
		PreemptableVm vmP2 = new PreemptableVm(6, 1, cpuReq, memReq, 5, PRIORITY_FREE, runtime);
	...
	public void testCalcMipsOfSamePriorityToBeAvailable7() {
		...
		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_BATCH).isEmpty());

		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0, policy.getPriorityToVms().get(PRIORITY_FREE).size());
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_FREE).isEmpty());
		...
		// vm with priority 1
		vm1 = new PreemptableVm(1, 1, cpuReq, memReq, 5, PRIORITY_BATCH, runtime);
		...
		// vm with priority 2		
		vm2 = new PreemptableVm(2, 1, cpuReq, memReq, 5, PRIORITY_FREE, runtime);
		// checking vm availability and zero mips will be available
		Assert.assertEquals(0, vm2.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0, policy.calcMipsOfSamePriorityToBeAvailable(vm2), ACCEPTABLE_DIFFERENCE);
	}
	...
	public void testCalcMipsOfSamePriorityToBeAvailable8() {
		...
		vm0 = new PreemptableVm(vmId++, userId, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		vm1 = new PreemptableVm(vmId++, userId, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		...
		Assert.assertEquals(10, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2, policy.getPriorityToVms().get(PRIORITY_FREE).size());
		Assert.assertEquals(vm0, policy.getPriorityToVms().get(PRIORITY_FREE).first());
		Assert.assertEquals(vm1, policy.getPriorityToVms().get(PRIORITY_FREE).last());
		...
		vm2 = new PreemptableVm(vmId++, userId, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		vm2.setStartExec(2);
	...
	/*
	 * The arrivingVm doesn't violate its SLO target now, but it will violate in next time
	 */
	@Test
	public void testCalcMipsOfSamePriorityToBeAvailable9() {
		int vmId = 0;
		int userId = 1;
		double memReq = 0;
		double runtime = 10;
		...
		//simulating VM is running since time 2
		vm2 = new PreemptableVm(vmId++, userId, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		vm2.setStartExec(2.5);

		// checking current vm availabilities
		Assert.assertEquals(1, vm0.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, vm1.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0.5, vm2.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
	...
	/*
	 * The arrivingVm violates its SLO target now
	 */
	@Test
	public void testCalcMipsOfSamePriorityToBeAvailable10() {
		int vmId = 0;
		int userId = 1;
		double memReq = 0;
		double runtime = 10;
		...
		//simulating VM is running since time 2
		vm2 = new PreemptableVm(vmId++, userId, cpuReq, memReq, 0, PRIORITY_FREE, runtime);
		vm2.setStartExec(2.501);

		// checking current vm availabilities
		Assert.assertEquals(1, vm0.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, vm1.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0.4998, vm2.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
	...
	public void testIsSuitableFor() {
		...
		PreemptableVm vmP0 = new PreemptableVm(vmId++, userId, cpuReq, memReq, submitTime, PRIORITY_PROD, runtime);
		...
		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_PROD).size());
		Assert.assertEquals(vmP0, policy.getPriorityToVms().get(PRIORITY_PROD).first());
		...
		// vm with priority 1
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_BATCH, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 6, memReq, submitTime, PRIORITY_BATCH, runtime)));

		// vm with priority 2
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_FREE, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 6, memReq, submitTime, PRIORITY_FREE, runtime)));
	}
	...
	public void testIsSuitableFor2() {
		...
		PreemptableVm vmP2 = new PreemptableVm(vmId++, userId, cpuReq, memReq, submitTime, PRIORITY_FREE, runtime);
		...
		// checking after allocating VM
		Assert.assertEquals(0, policy.getPriorityToInUseMips().get(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0, policy.getPriorityToVms().get(PRIORITY_PROD).size());
		Assert.assertTrue(policy.getPriorityToVms().get(PRIORITY_PROD).isEmpty());
		...
		Assert.assertEquals(cpuReq, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_FREE).size());
		Assert.assertEquals(vmP2, policy.getPriorityToVms().get(PRIORITY_FREE).first());
		...
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 6, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_BATCH, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 11, memReq, submitTime, PRIORITY_BATCH, runtime)));

		// vm with priority 0
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime,PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 6, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_PROD, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 11, memReq, submitTime, PRIORITY_PROD, runtime)));
	}
	...
	public void testIsSuitableFor3() {
		...
		PreemptableVm vmP1 = new PreemptableVm(vmId++, userId, cpuReq/2, memReq, submitTime, PRIORITY_BATCH, runtime);
		...
		Assert.assertEquals(cpuReq/2, policy.getPriorityToInUseMips().get(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_BATCH).size());
		Assert.assertEquals(vmP1, policy.getPriorityToVms().get(PRIORITY_BATCH).first());
		...
		Assert.assertEquals(10, policy.getAvailableMipsByPriority(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(7.5, policy.getAvailableMipsByPriority(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2.5, policy.getAvailableMipsByPriority(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);

		// vm with priority 0
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.4, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.5, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.6, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.4, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.5, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.6, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_PROD, runtime)));
		...
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.5, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.6, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.5, memReq, submitTime, PRIORITY_BATCH, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.6, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 11, memReq, submitTime, PRIORITY_BATCH, runtime)));

		// vm with priority 2
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.4, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.5, memReq, submitTime, PRIORITY_FREE, runtime)));

		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.6, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 4.9, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.4, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.5, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.6, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 11, memReq, submitTime, PRIORITY_FREE, runtime)));
	}
	...
	public void testIsSuitableFor4() {
		...
		vm0 = new PreemptableVm(vmId++, userId, cpuReq, memReq, submitTime, PRIORITY_PROD, runtime);
		vm1 = new PreemptableVm(vmId++, userId, (cpuReq/2), memReq, submitTime, PRIORITY_BATCH, runtime);
		vm2 = new PreemptableVm(vmId++, userId, (cpuReq/2), memReq, submitTime, PRIORITY_FREE, runtime);
		...
		Assert.assertEquals(cpuReq/2, policy.getPriorityToInUseMips().get(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(1, policy.getPriorityToVms().get(PRIORITY_FREE).size());
		Assert.assertEquals(vm2, policy.getPriorityToVms().get(PRIORITY_FREE).first());

		//checking availableMipsByPriority
		Assert.assertEquals(5, policy.getAvailableMipsByPriority(PRIORITY_PROD), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(2.5, policy.getAvailableMipsByPriority(PRIORITY_BATCH), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(0, policy.getAvailableMipsByPriority(PRIORITY_FREE), ACCEPTABLE_DIFFERENCE);
		...
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.0001, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.4, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.5, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.6, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_PROD, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 11, memReq, submitTime, PRIORITY_PROD, runtime)));



		// vm with priority 1. It's possible to preempt one vm with priority 1, because its SLO is > 90 %. So, available mips = 5
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.5, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.6, memReq, submitTime, PRIORITY_BATCH, runtime)));
		...
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.0001, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 5.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.4, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.5, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 7.6, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 9.9, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10, memReq, submitTime, PRIORITY_BATCH, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(vmId, userId, 10.1, memReq, submitTime, PRIORITY_BATCH, runtime)));
		...
		// vm with priority 2.  It's possible to preempt one vm with priority 2, because its SLO is > 50 %. So, available mips = 2.5
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 1, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.4, memReq, submitTime, PRIORITY_FREE, runtime)));
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(vmId, userId, 2.5, memReq, submitTime, PRIORITY_FREE, runtime)));
	...
	public void testIsSuitableFor5() {
		...
		vm0 = new PreemptableVm(0, 1, cpuReq, memReq, 0, 0, runtime);
		vm1 = new PreemptableVm(1, 1, cpuReq/2, memReq, 0, 1, runtime);
		vm2 = new PreemptableVm(2, 1, cpuReq/2, memReq, 0, 2, runtime);
		...
		// vm with priority 2
		Assert.assertTrue(policy.isSuitableFor(new PreemptableVm(1, 1, 0, memReq, time, 2, runtime)));
		Assert.assertFalse(policy.isSuitableFor(new PreemptableVm(1, 1, 0.0000000001, memReq, time, 2, runtime)));
	...
	public void testIsSuitableFor6() {
		...
		// new VMs with priority 2 aren't violating the SLO target (0.6 > 0.5),
		// neither vm will be preempted, so available for vms with priority 2 is 0
		arrivingVM = new PreemptableVm(1, 1, 0.0000001, memReq, submitTime, 2, runtime);
		arrivingVM.setStartExec(2);
		Assert.assertFalse(policy.isSuitableFor(arrivingVM));
	...
	public void testGetAvailableMipsByPriority() {
		...
		vm0 = new PreemptableVm(0, 1, cpuReq, memReq, 0, 0, runtime);
		vm1 = new PreemptableVm(1, 1, cpuReq, memReq, 0, 1, runtime);
		vm2 = new PreemptableVm(2, 1, cpuReq, memReq, 0, 2, runtime);
		...
		// checking available mips in time 0
		Assert.assertEquals(10 - cpuReq, policy.getAvailableMipsByPriority(0), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - 2 * cpuReq, policy.getAvailableMipsByPriority(1), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - 3 * cpuReq, policy.getAvailableMipsByPriority(2), ACCEPTABLE_DIFFERENCE);
		...
		// checking available mips in time 5
		Assert.assertEquals(10 - cpuReq, policy.getAvailableMipsByPriority(0), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - 2 * cpuReq, policy.getAvailableMipsByPriority(1), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - 3 * cpuReq, policy.getAvailableMipsByPriority(2), ACCEPTABLE_DIFFERENCE);
	}
	...
	public void testGetAvailableMipsByVm() {
		...
		// check VM with the same priority would be preempted by new ones
		// (priority 0 is a exception, it must not be preempted)
		PreemptableVm vmP0 = new PreemptableVm(4, 1, cpuReq, memReq, 5, 0, runtime);
		Assert.assertEquals(0, vmP0.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - cpuReq, policy.getAvailableMipsByVm(vmP0), ACCEPTABLE_DIFFERENCE);

		PreemptableVm vmP1 = new PreemptableVm(5, 1, cpuReq, memReq, 5, 1, runtime);
		Assert.assertEquals(0, vmP1.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - cpuReq, policy.getAvailableMipsByVm(vmP1), ACCEPTABLE_DIFFERENCE);

		PreemptableVm vmP2 = new PreemptableVm(6, 1, cpuReq, memReq, 5, 2, runtime);
		Assert.assertEquals(0, vmP2.getCurrentAvailability(5), ACCEPTABLE_DIFFERENCE);
		Assert.assertEquals(10 - 2 * cpuReq, policy.getAvailableMipsByVm(vmP2), ACCEPTABLE_DIFFERENCE);
	}
}
