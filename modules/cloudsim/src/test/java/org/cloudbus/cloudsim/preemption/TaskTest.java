...
public class TaskTest {
    ...
    private static Task task1, task2, task3, task4, task5, task6, task7;
    private static final double SUBMIT_TIME = 30.546;
    private static final int PRIORITY = 1;

    @Test
    public void testCompareToEquals(){
        task1 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY - 1);
        task2 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY - 1);
    ...
    public void testCompareToId(){
        task1 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        task2 = new Task(2, SUBMIT_TIME, 1, 1, 1, PRIORITY);
    ...
    public void testCompareToPrority(){
        task1 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY - 1);
        task2 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        Assert.assertEquals(-1, task1.compareTo(task2));
        Assert.assertEquals(1, task2.compareTo(task1));
    }
    ...
    public void testCompareToSubmit(){
        task1 = new Task(1, SUBMIT_TIME - 1, 1, 1, 1, PRIORITY);
        task2 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        Assert.assertEquals(-1, task1.compareTo(task2));
        Assert.assertEquals(1, task2.compareTo(task1));
    }
    ...
    public void testCompareToSubmit2(){
        task1 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        task2 = new Task(1, SUBMIT_TIME + 0.0000001, 1, 1, 1, PRIORITY);
        Assert.assertEquals(-1, task1.compareTo(task2));
        Assert.assertEquals(1, task2.compareTo(task1));
    }
    ...
    public void testCompareToSubmit3(){
        task1 = new Task(1, SUBMIT_TIME - 0.0000001, 1, 1, 1, PRIORITY);
        task2 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        Assert.assertEquals(-1, task1.compareTo(task2));
        Assert.assertEquals(1, task2.compareTo(task1));
    }
    ...
    public void testTreeSetOrder(){
        SortedSet<Task> sortedTasks = new TreeSet<>();

        task1 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        task2 = new Task(3, SUBMIT_TIME - 1, 1, 1, 1, PRIORITY + 1);
        task3 = new Task(2, SUBMIT_TIME + 1, 1, 1, 1, PRIORITY - 1);
        ...
        task4 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY);
        sortedTasks.add(task4);
        Assert.assertEquals(3, sortedTasks.size());

        // inserting task4 at first position
        task4 = new Task(1, SUBMIT_TIME - 1, 1, 1, 1, PRIORITY);
        sortedTasks.add(task4);
        ...
        task5 = new Task(1, SUBMIT_TIME, 1, 1, 1, PRIORITY + 1);
        ...
        task6 = new Task(1, SUBMIT_TIME + 1, 1, 1, 1, PRIORITY);
        ...
        task7 = new Task(3, SUBMIT_TIME + 1, 1, 1, 1, PRIORITY);
        ...
        Task task8 = new Task(2, SUBMIT_TIME + 1, 1, 1, 1, PRIORITY);
    ...
    public void testEquals(){
        // test runTime
        task1 = new Task(1, SUBMIT_TIME, 3, 1, 1, PRIORITY);
        task2 = new Task(1, SUBMIT_TIME, 2, 1, 1, PRIORITY);
        task3 = new Task(1, SUBMIT_TIME, 2, 1, 1, PRIORITY);
