...
//		for (int i = 0; i < numberOfVms; i++) {
//			datacenter.allocateHostForVm(false, (PreemptableVm) vmP0S1.get(i), null);
//		}
//
...
//		for (int i = 0; i < numberOfVms; i++) {
//			datacenter.allocateHostForVm(false, (PreemptableVm) vmP0S0.get(i), null);
//		}
//
//		//testing capacity of host
...
//
//		for (int i = 0; i < numberOfVms; i++) {
//			datacenter.allocateHostForVm(false, (PreemptableVm) vmP1S0.get(i), null);
//		}
//
//		//testing capacity of host
...
//
//		for (int i = 0; i < numberOfVms; i++) {
//			datacenter.allocateHostForVm(false, (PreemptableVm) vmP2S0.get(i), null);
//		}
//		//testing capacity of host
