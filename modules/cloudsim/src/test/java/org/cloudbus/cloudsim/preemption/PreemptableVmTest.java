...
public class PreemptableVmTest {
	...
	public void testCompareTo() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime + 1, priority + 1, 0, 0.9);
	...
	public void testCompareTo2() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime, priority, 0, 1);
	...
	public void testCompareTo3() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime + 1, priority, 0, 1);
	...
	public void testCompareTo4() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime, priority + 1, 0, 0.9);
	...
	public void testCompareTo5() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime + 1, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime, priority + 1, 0, 0.9);
	...
	public void testCompareTo6() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority + 1, 0, 0.9);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime, priority, 0, 1);
	...
	public void testActualRuntime() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, runtime, 1);
	...
	public void testSorting() {
		...
		PreemptableVm vm1 = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, 0, 1);
		PreemptableVm vm2 = new PreemptableVm(2, 1, 1.0, 1.0, submitTime + 1, priority, 0, 1);
		PreemptableVm vm3 = new PreemptableVm(3, 1, 1.0, 1.0, submitTime, priority + 1, 0, 0.9);
		...
		PreemptableVm vm4 = new PreemptableVm(4, 1, 1.0, 1.0, submitTime + 1, priority + 1, 0, 0.9);
		PreemptableVm vm5 = new PreemptableVm(5, 1, 1.0, 1.0, submitTime, priority + 2, 0, 0.5);
		...
		PreemptableVm vm6 = new PreemptableVm(4, 1, 1.0, 1.0, submitTime - 1, priority, 0, 1);
		sortedVms.add(vm6);
	...
	@Test
	public void testIsAvailabilityAboveOfTarget() {
		int submitTime = 0;
		int priority = 1;
		double runtime = 20;
		double time = 0;

		PreemptableVm vm = new PreemptableVm(1, 1, 1.0, 1.0, submitTime, priority, runtime, 0.9);
		vm.setStartExec(time);

		// checking time == submiTime
		Assert.assertEquals(0, vm.getCurrentAvailability(time), ACCEPTABLE_DIFFERENCE);
		Assert.assertFalse(vm.isAvailabilityAboveOfTarget(time));

		// passing time
		time = 1;
		
		// checking time == submiTime
		Assert.assertEquals(1, vm.getCurrentAvailability(time), ACCEPTABLE_DIFFERENCE);
		Assert.assertTrue(vm.isAvailabilityAboveOfTarget(time));
		...
		// passing time
		time = 5;
		Assert.assertEquals(0.8, vm.getCurrentAvailability(time), ACCEPTABLE_DIFFERENCE);
		Assert.assertFalse(vm.isAvailabilityAboveOfTarget(time));
		...
		// passing time
		time = 10;
		Assert.assertEquals(0.9, vm.getCurrentAvailability(time), ACCEPTABLE_DIFFERENCE);
		Assert.assertFalse(vm.isAvailabilityAboveOfTarget(time));

		// passing time
		time = 20;
		Assert.assertEquals(0.95, vm.getCurrentAvailability(time), ACCEPTABLE_DIFFERENCE);
		Assert.assertTrue(vm.isAvailabilityAboveOfTarget(time));
	}
}
